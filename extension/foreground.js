...
//     // Get the last mutation in mutations that actually has an addedNode
//     // Get the addedNode(s) and get its div.innerText
//     // Track prev and curr values
...
//     // console.log("prevCaptions: ", prevCaptions);
...
setTimeout(function () {
  chrome.runtime.sendMessage("", {
    type: "notification",
    options: {
      title: makeUppercase("triple double") + moreInfo,
      message: phrases["triple double"],
      iconUrl: "images/logo.png",
      type: "basic",
    },
  });
